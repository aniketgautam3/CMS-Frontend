...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
        ...
        <button class="btn btn-link position-absolute d-md-none col-md-3 col-lg-2 collapsed me-0 px-3" type="button" data-bs-toggle="collapse"
            data-bs-target=".js-sidebar" aria-expanded="false"
            aria-label="Toggle navigation" style="box-shadow: none;">
            <span class="navbar-toggler-icon"></span>
        </button>
        
        <div class="dropdown">
            <a href="#" class="link-light text-decoration-none dropdown-toggle px-2" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="https://avatars.githubusercontent.com/u/123241206?s=400&v=4" class="rounded-circle" width="32" height="32">
            </a>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main id="main-content" class="col-md-9 ms-sm-auto col-lg-10 px-3 py-2"  style="min-height: calc(100vh - 40px);">
                Loading...
            </main>
